      ...
      <div className="flex-1 overflow-y-auto">
        <div className="p-2 md:p-4 h-full">
          <div className="flex-1 flex items-center justify-center p-4 h-full">
            ...
            >
              <div className="bg-white/10 dark:bg-gray-800/50 backdrop-blur-xl rounded-3xl p-6 md:p-8 shadow-xl border border-white/20">
                ...
                <div className="flex justify-center">
                  <div className="w-48 h-48 flex items-center justify-center bg-blue-400 dark:bg-gray-900 text-white rounded-full shadow-lg">
