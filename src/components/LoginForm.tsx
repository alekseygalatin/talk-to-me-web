...
const LoginForm: React.FC<LoginFormProps> = ({ email, password, setEmail, setPassword, setError, setIsConfirming, setIsSignInTab, setIsForgotPassword }) => {
    ...
    return (
        ...
        <form onSubmit={handleLogin} className="space-y-6 mt-4">
          ...
          <div>
            ...
            <span className='text-sm font-medium text-blue-700 dark:text-blue-400 cursor-pointer inline-block mt-2'
        ...
        <div className="inline-flex items-center justify-center w-full">
          ...
          <span className="absolute px-3 uppercase font-medium text-gray-900 -translate-x-1/2 bg-white left-1/2 dark:text-white dark:bg-gray-800">or</span>
        </div>
        <button type="button" className="w-full py-3 px-4 justify-center text-center inline-flex items-center me-2 mb-2 font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
